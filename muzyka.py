...
print(np.std(predx[:, -5:], axis=0), np.sum((predx[-82:, -5:] - wynik[-1])**2))
...
print(len(order[-1]))
name = ['Sezon 3 chapter 1','Sezon 3 chapter 2', 'Sezon 3 chapter 3', '25 Sezon 9 chapter 1']
s.create_new_playlists(order, name[-4:])
